    ...
    return (
        <div className="relative grid min-h-[100vh] w-screen p-8">
            <div className="flex flex-col-reverse items-center justify-between gap-4 self-start md:flex-row">
                <Card className="border-blue-gray-50 shadow-blue-gray-900/5 h-max w-max border px-5 py-4 shadow-lg">
                    <code className="text-blue-gray-900">
                        Get started by editing <strong>app/routes/_index.tsx</strong>
                    </code>
                </Card>
                <Card className="border-blue-gray-50 text-blue-gray-900 shadow-blue-gray-900/5 h-max w-max flex-row items-center border font-semibold shadow-lg">
                    <img
                        src="/favicon.ico"
                        alt="Remix Logo"
            ...
            <div className="grid grid-cols-1 gap-4 self-end md:grid-cols-2 lg:grid-cols-4">
                <a
                    ...
                    <Card
                        shadow={false}
                        className="border-blue-gray-50 hover:border-blue-gray-100/60 hover:shadow-blue-gray-900/5 border px-5 py-4 shadow-xl shadow-transparent transition-all hover:-translate-y-4">
                        <Typography
                            variant="h5"
                            color="blue-gray"
