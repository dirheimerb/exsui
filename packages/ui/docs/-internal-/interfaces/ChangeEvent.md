...
[@exsui/ui](../../README.md) / [\<internal\>](../README.md) / ChangeEvent
...
> **target**: [`EventTarget`](https://developer.mozilla.org/docs/Web/API/EventTarget) & `T`
...
node\_modules/.pnpm/@types+react@18.2.69/node\_modules/@types/react/index.d.ts:2185
