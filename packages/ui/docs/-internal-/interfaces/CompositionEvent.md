...
- [`SyntheticEvent`](SyntheticEvent.md)\<`T`, [`NativeCompositionEvent`](../type-aliases/NativeCompositionEvent.md)\>
...
node\_modules/.pnpm/@types+react@18.2.69/node\_modules/@types/react/index.d.ts:2152
