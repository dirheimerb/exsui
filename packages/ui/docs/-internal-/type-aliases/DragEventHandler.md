...
> **DragEventHandler**\<`T`\>: [`EventHandler`](EventHandler.md)\<[`DragEvent`](../interfaces/DragEvent.md)\<`T`\>\>
...
node\_modules/.pnpm/@types+react@18.2.69/node\_modules/@types/react/index.d.ts:2299
