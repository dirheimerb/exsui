...
<div className="sb-container">
  <div className='sb-section-title'>
    ...
    The only components you need to build an amazing web application.
  ...
  <div className="sb-section">
    <div className="sb-section-item">
      ...
      <p className="sb-section-item-paragraph">
        Style your components using CSS-in-JS, CSS, or any other styling
        solution you prefer.
      </p>
      <a
    ...
    <div className="sb-section-item">
      ...
      />
      <h4 className="sb-section-item-heading"></h4>
